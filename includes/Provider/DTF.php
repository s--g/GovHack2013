...
class Provider_DTF
{
	const DTF_URL = 'http://www.dtf.wa.gov.au/UnclaimedMonies/queryUM.asp';
	...
	public static function searchByFacebook($facebookFriend)
	{
		...
		curl_setopt($ch,CURLOPT_URL, self::DTF_URL);
		...
		while($pos !== false)
		{
			...
			if($i > 10000)
				die('Somtheing unexpected happened.  Sorry about that.');
